...
for($i = 1; $i <= 100; $i++){
    if($i % 3 == 0 && $i % 5 == 0 ){
        echo $i . ' is dvisible by 3 and 5 <br>';
    }
    else if($i % 3 == 0){
...
<body class="bg-gray-100">
  <header class="bg-blue-500 text-white p-4">
    <div class="container mx-auto">
      <h1 class="text-3xl font-semibold">PHP LAB 4</h1>
    </div>
  </header>
  <div class="container mx-auto p-4 mt-4">
    <div class="bg-white rounded-lg shadow-md p-6 mt-6">
      ...
      <?php for($i = 1; $i <= 100; $i++) : ?>
        <?php if($i % 3 == 0 && $i % 5 == 0) : ?>
          <p><?= $i ?> is divisible by 3 and 5</p><br>
        <?php elseif($i % 3 == 0) : ?>
          <p><?= $i ?> is divisible by 3</p><br>
        <?php elseif($i % 5 == 0) : ?>
          <p><?= $i ?> is divisible by 5</p><br>
        <?php else : ?>
          <p><?= $i ?></p><br>
        <?php endif; ?>
      <?php endfor; ?>
